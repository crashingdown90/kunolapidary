...
export default function CoreDisciplines() {
  return (
    <section className="py-32 relative bg-light/30 border-y border-border">
        ...
        <div className="grid md:grid-cols-3 gap-12">
          {categories.map((cat) => (
            <Link
              ...
              className={`group glass-card block p-12 rounded-[40px] border border-border transition-all duration-700 ${cat.glowColor}`}
            >
