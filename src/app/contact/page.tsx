        ...
        <div className="grid gap-12 lg:grid-cols-3">
          ...
          <div className="space-y-8">
            ...
            <div className="rounded-xl border border-[#D2B48C]/30 bg-white p-6 shadow-sm">
              ...
              <p className="mb-4 text-sm text-[#2D1810]/70">
              ...
              <div className="flex gap-3">
                ...
                <a
                  href="#"
                  aria-label="Facebook"
                  className="flex h-10 w-10 items-center justify-center rounded-lg bg-[#F5E6D3]/50 text-[#5C4033] transition-colors hover:bg-[#8B6914]/10 hover:text-[#8B6914]"
                >
