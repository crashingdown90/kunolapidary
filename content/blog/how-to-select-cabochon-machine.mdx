...
If you've been cutting stones by [hand](/blog/how-to-[polish](/blog/polishing-obsidian-tips-and-tricks)-rocks-by-hand-without-a-tumbler) using sandpaper, or trying to shape cabochons using a rotary Dremel tool, you already know the limitations of those methods. The process is slow, the polish is often inconsistent, and achieving perfect symmetry is nearly impossible.

Moving up to a dedicated **[cabochon](/blog/cutting-your-first-cabochon-step-by-step) machine** (often called a "cabbing machine" or "arbor") is a major milestone for any [lapidary](/blog/beginners-guide-to-lapidary) artist. These machines feature a single spinning shaft loaded with 4 to 8 grinding and polishing wheels of progressively finer grits. They allow you to take a stone from a rough pre-form to a glossy, finished cabochon in a matter of minutes, moving seamlessly from left to right across the machine.
