...
faq:
  - question: "What is the Mohs hardness scale?"
    answer: "The Mohs hardness scale is a qualitative scale from 1 to 10 that ranks minerals by their resistance to scratching. Developed in 1812 by Friedrich Mohs, it uses ten reference minerals from talc (1, softest) to diamond (10, hardest). Each mineral can scratch all those below it on the scale."
  - question: "Is the Mohs scale linear?"
    answer: "No, the Mohs scale is ordinal, not linear. The gaps between numbers are not equal. For example, diamond (10) is roughly four times harder than corundum (9) in absolute terms, while the difference between talc (1) and gypsum (2) is much smaller. The scale only indicates relative scratch resistance."
  - question: "What Mohs hardness is needed for jewelry?"
    answer: "Gemologists generally recommend a hardness of at least 7 for ring stones, since ordinary dust contains quartz particles (hardness 7) that can scratch softer gems over time. Stones softer than 7 (like opal, turquoise, and pearl) are better suited for earrings, pendants, and brooches that receive less abrasion."
---

## What Is the Mohs Hardness Scale?

The Mohs Hardness Scale is a qualitative ordinal scale that ranks minerals based on their resistance to scratching. Developed in 1812 by German mineralogist Friedrich Mohs, it remains one of the most widely used tools in geology, gemology, and [lapidary](/blog/beginners-guide-to-lapidary) work more than two centuries after its creation. The scale ranks ten common minerals from 1 (softest) to 10 (hardest), with each reference mineral able to scratch all those below it in the ranking.
...
[Quartz](/blog/types-of-quartz-complete-guide) is one of the most important minerals for both geologists and lapidarists. It scratches glass, steel, and all softer minerals with ease. Quartz is the most abundant mineral in the Earth's continental crust and occurs in an astonishing variety of forms — from clear rock crystal and purple [amethyst](/blog/amethyst-vs-citrine) to banded agate and fine-grained jasper. Its hardness of 7 makes it an excellent benchmark: any gemstone softer than quartz is vulnerable to scratching by ordinary dust, which contains microscopic quartz particles.
...
Performing a Mohs hardness test is straightforward, but attention to detail matters. For a complete guide to mineral testing techniques, see our article on [how to identify gemstones at home](/blog/how-to-identify-gemstones-at-home).
