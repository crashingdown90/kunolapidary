...
When molten rock (magma) cools, the atoms within it slow down and begin to arrange themselves into crystal lattices. The rate of cooling is critical:
...
A gem cutter orienting a sapphire must consider the crystal's optical axis to maximize color. A lapidarist cutting a moonstone must orient the cabochon to display the adularescence from the correct angle. A faceter working with topaz must avoid cutting perpendicular to the basal cleavage plane to prevent the stone from splitting.
