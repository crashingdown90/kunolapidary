...
metaDescription: "Learn about agate types. Discover every type of agate — banded, moss, fire, Lake Superior, blue lace, crazy lace, and more. Learn identification tips and how..."
keywords:
  - "agate types"
  ...
  - "agate collecting"
faq:
  - question: "How can you tell if a rock is an agate?"
    answer: "Agates are identified by their distinctive banding or translucency, waxy luster, hardness of 7 on the Mohs scale, conchoidal fracture pattern, and lack of cleavage. Hold the stone up to a light — most agates will show some degree of translucency along thin edges."
  - question: "What is the rarest type of agate?"
    answer: "Fire agate is among the rarest and most valuable agate varieties. Its iridescent play of color, caused by thin layers of iron oxide over chalcedony, produces a fiery rainbow effect similar to opal. Fine fire agates from Mexico and Arizona are highly prized by collectors."
  - question: "How are agates formed?"
    answer: "Agates form when silica-rich groundwater fills cavities in volcanic rock, depositing microscopic layers of chalcedony over thousands to millions of years. Each layer may differ in color and translucency due to variations in mineral content and conditions during deposition."
---

Discover the essentials of **[Agate](/blog/collecting-agates-beach) types** in this guide.

## What Is Agate?

Agate is a variety of chalcedony — microcrystalline [quartz](/blog/types-of-quartz-complete-guide) — characterized by its distinctive banding or patterning. With a [Mohs hardness](/blog/understanding-the-mohs-hardness-scale) of 7 and excellent toughness, agate is one of the most important materials in the [lapidary](/blog/beginners-guide-to-lapidary) world and one of the most collected minerals on the planet.
...
The name "agate" comes from the Achates River (now the Dirillo) in Sicily, where the [ancient](/blog/ancient-lapidary-techniques-history) Greeks first collected the stone. Agate has been used for jewelry, amulets, and decorative objects for at least 3,000 years, and it remains as popular today as it was in antiquity.
...
India is a major source of green moss agate. Montana moss agate, found in the gravels of the Yellowstone River, is prized for its scenic inclusions of dark dendrites against a translucent background. Moss agate is a favorite among [cabochon](/blog/cutting-your-first-cabochon-step-by-step) cutters because every piece is unique, and the inclusions create natural landscapes within the stone.
